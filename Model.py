...
def Decoder(input_shape, low_res_shape, high_res_shape, hidden_shape, attn_sum_low_shape, attn_sum_high_shape, num_classes, embedding_dim = 256, hidden_size = 256):
        
    inputs = tf.keras.Input(shape = input_shape); # previous token
...
class MathOCR(tf.keras.Model):
    ...
    def __init__(self, output_filters = 48, dropout_rate = 0.2, embedding_dim = 256, hidden_size = 256, tokens_length_max = 90):
